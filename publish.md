...
## 2.017_2019_0302（预计20190312发布）
- 新功能与优化
1. 续费情况，出证明情况
2.引用宣传，形成促销活动，并做数据统计
## 2.017_2019_0302（当前版本）
- 新功能与优化
1. 货运上传增加注册及登录
2. Pc端增加行驶证识别，行驶证识别不了时可继续上传，后续资料人工补齐；
## 2.016_2019_0221
- 新功能与优化
1. 导入车辆的配件（仅支持已经有新装单的车辆）；
2. 导入分销数据；
3. 车辆、客户列表重构（下单、续费、约车记录，客户下单的价格体系）；
